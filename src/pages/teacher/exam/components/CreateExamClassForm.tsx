...
const CreateClassModal: React.FC<IProps> = (props) => {
  ...
  const handleNext = async () => {
    ...
    handleCreate({ ...values, classId: scalssInfo.id });
  };
  ...
  return (
    ...
    >
      <Form
        ...
        labelCol={{ span: 6 }}
        wrapperCol={{ span: 18 }}
        initialValues={{ id: -1, courseId: Number(scalssInfo.courseId), }}
        form={form}
      >
        ...
        <Form.Item label="班级名称">
          <span>{scalssInfo.className}</span>
        </Form.Item>
